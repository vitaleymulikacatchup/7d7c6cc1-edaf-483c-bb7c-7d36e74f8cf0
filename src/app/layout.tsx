...
export const metadata: Metadata = {
  title: "Coffee Haven - Premium Specialty Coffee & Café",
  description: "Discover exceptional specialty coffee sourced from sustainable farms. Visit our cozy café for expertly crafted espresso, single-origin beans, and welcoming atmosphere.",
  keywords: "specialty coffee, café, barista, espresso, single origin, coffee shop, latte, cappuccino",
  ...
  openGraph: {
    title: "Coffee Haven - Premium Specialty Coffee & Café",
    description: "Experience exceptional specialty coffee crafted with passion. Visit us for perfectly brewed espresso and a welcoming community.",
    url: "https://coffeehaven.com",
    siteName: "Coffee Haven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763480901553-63o68ckc.jpg",
  ...
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763480901553-63o68ckc.jpg"]
  },
  robots: {
    index: true,
    follow: true
